...
var define_parameters = function(exp_stage){
 ...
 // limiting choice time here.
  ...
  var stg_bkg_x = w/2 - background_width/2 + diode_width;
  ...
  var image_x = w/2 - img_bkg_width/4 - image_width/2 + diode_width;
  ...
  var img_bkg_x = w/2 - img_bkg_width/2 + diode_width;
  ...
  var text_x = w/2 + image_width/2 + diode_width;
  ...
  var slow_reply_x = w/2 + diode_width;
  ...
  var choice_stim_bkg_x = w/2 - choice_stim_bkg_width/2 + diode_width;
  ...
  var choice_stim_x = w/2 - choice_stim_width/2 + diode_width;
...
var place_diode2 = function(background_height, background_width, h){
  ...
  d3.select("svg")
    ...
    .attr("width", diode_width)
    .attr("y", h - diode_height)
    .attr("x", background_width - diode_width)
    .style("fill", "black")
    .style("opacity", 0)
}
...
var display_diode2 = function(){
  d3.select(".diode2").style("opacity",1);
}
...
var remove_diode2 = function(){
  d3.select(".diode2").style("opacity",0);
}
