...
jsPsych.plugins["evan-localizer-trial3"] = (function() {
...
/*    d3.select('svg')
    ...
    place_diode2(par.background_height, par.w, par.h);
    ...
    if (trial.slot_machine){
      place_img_bkg("stg1",par.choice_stim_bkg_x,par.choice_stim_bkg_y,
                    par.choice_stim_bkg_width,par.choice_stim_bkg_height,
                      par.choice_stim_bkg_color,0);
      place_img(trial.image, "stg1", par.choice_stim_x,
                  par.choice_stim_y, par.choice_stim_width,
                  par.choice_stim_height,0);
    }else{
      place_img_bkg("stg1",par.f_outcome_img_bkg_x,par.f_outcome_img_bkg_y,par.f_outcome_img_bkg_width,par.f_outcome_img_bkg_height,par.img_bkg_color,0);
      place_img(trial.image, "stg1", par.f_outcome_img_x, par.f_outcome_img_y,
                    par.f_outcome_img_width, par.f_outcome_img_height,0);
    }
    ...
    var loc_stage1 = function(){
      rafID1 = window.requestAnimationFrame(function() {
          rafID2 = window.requestAnimationFrame(function(timestamp) {
            ...
            d3.selectAll(".stg1,.diode,.diode2").style("opacity",1)
          //  display_diode();
